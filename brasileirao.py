...
def ids_dos_melhor_classificados(dados,numero_de_times):
   resposta = []
   for posicao in range(numero_de_times):               #[0,1,2,3,4,5]       [0,1,2]
...
def id_do_time(dados,nome_time_procurado):
   ...
   for id_time in dic_equipes.keys(): 
       nome_time = (dados['equipes'][id_time] 
                         ['nome-comum'])
...
def dicionario_id_estadio_e_nro_jogos(dados):
   ...
   conta_jogos = {} 
   for id_jogo in dic_jogos:
       estadio_id = (dic_jogos[id_jogo]['estadio_id'])      
       if estadio_id not in conta_jogos:
           conta_jogos[estadio_id] = 1
       else:
           conta_jogos[estadio_id] += 1
   return conta_jogos
...
def ids_de_jogos_de_um_time(dados,time_id):
   ...
   ids_jogos_do_time = []
   for id_jogo in dic_jogos:
       (time1, time2) = (dic_jogos[id_jogo]['time1'], dic_jogos[id_jogo]['time2'])
       if (time1 == time_id) or (time2 == time_id):
           ids_jogos_do_time.append(id_jogo)
   return ids_jogos_do_time
...
def datas_de_jogos_de_um_time(dados,nome_time):
   ...
   for id_jogo in dic_jogos:
       ...
       if (time1 == time_id) or (time2 == time_id):
           ...
           datas_jogos_do_time.append(data)
   return datas_jogos_do_time
...
def dicionario_de_gols(dados):
   ...
   for id_jogo in dic_jogos:
       time1,   time2   = dic_jogos[id_jogo]['time1'], dic_jogos[id_jogo]['time2']
       placar1, placar2 = dic_jogos[id_jogo]['placar1'], dic_jogos[id_jogo]['placar2']
       placar1, placar2 = int(placar1), int(placar2)
       if time1 not in gols_do_time:
           gols_do_time[time1] =  placar1
       else:
           gols_do_time[time1] += placar1


       if time2 not in gols_do_time:
           gols_do_time[time2] =  placar2
       else:
           gols_do_time[time2] += placar2
   return gols_do_time
...
def time_que_fez_mais_gols(dados):
   ...
   for id_time in dic_gols:
       gols_time = dic_gols[id_time]
       if gols_time > gols_maximo:
           id_goleador = id_time
           gols_maximo = gols_time
   return id_goleador
